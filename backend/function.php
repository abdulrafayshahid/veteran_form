...
try {
    ...
    if (isset($_POST['consent_blanks']) && $_POST['consent_blanks'] !== null) {

        $consent_blanks_arr = $_POST['consent_blanks'];
        $consent_blanks=implode(',',$consent_blanks_arr);
    } else {
        $consent_blanks = ''; 
    }
