    ...
    <div class="full-form">
        <form action="backend/function.php" method="post">
            <div id="form1">
                <div class="container">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" id="lastname" class="form-control" name="mi" placeholder="Enter your MI"
                                value="<?php echo !empty($middle_initial) ? $middle_initial : ''; ?>">
                        </div>
                        <div class="form-group col-md-6">
                    ...
                    <div class="row">
                        <div class="col-md-6 mt-3 form-group">
                            ...
                            <div class="form-check form-check-inline2">
                                <input class="form-check-input" name="gender" type="radio" id="trans_m_f"
                                    value="Trans M/F" <?php echo ($gender === 'Trans M/F') ? 'checked' : ''; ?>>
                                <label class="form-check-label" for="trans_m_f">Trans M/F</label>
                            </div>
                            <div class="form-check form-check-inline2">
                                <input class="form-check-input" name="gender" type="radio" id="trans_f_m"
                                    value="Trans F/M" <?php echo ($gender === 'Trans F/M') ? 'checked' : ''; ?>>
                                <label class="form-check-label" for="trans_f_m">Trans F/M</label>
                            </div>
                            <div class="form-check form-check-inline2">
                                <input class="form-check-input" name="gender" type="radio" id="non_conforming"
                                    value="Non-Conforming" <?php echo ($gender === 'Non-Conforming') ? 'checked' : ''; ?>>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" id="lastname" class="form-control" name="phone"
                                ...
                                value="<?php echo !empty($cell_phone) ? $cell_phone : ''; ?>">
                        </div>
                        <div class="form-group col-md-6">
                            <label for="emergency_contact_name">Emergency Contact Name</label>
                            <input type="text" id="emergency_contact_name" class="form-control"
                                name="emergency_contact_name" placeholder="Enter Referral Source">
                        </div>
                        <div class="form-group col-md-6">
                    ...
                    <div class="col-md-10 mt-3 form-group mt-5">
                        ...
                        <div class="form-check form-check-inline2">
                            <input class="form-check-input" name="copy_dd214" type="radio" id="male" value="Yes">
                            <label class="form-check-label" for="male">Yes</label>
                        </div>
                        <div class="form-check form-check-inline2">
                            <input class="form-check-input" name="copy_dd214" type="radio" id="male" value="No">
                ...
                <div class="consent container">
                    ...
                    <div class="row mt-5">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="date" id="date" class="form-control custom-input" name="consent_date"
                                placeholder="">
                        </div>
                    </div>
                </div>
                ...
                <div class="container">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-8">
                            <p>You have the right to:</p>
                            <ul>
                                <li>Address any program problem you have with the Veterans Inc. Case Manager. If s/he
                                    cannot solve your problem, please refer to next bullet;</li>
                                <li>Address your problem with the supervisor of the Case Manager. The supervisor will
                                    investigate the problem by talking to you and the Case Manager involved and will
                                    respond to you within 3 business days. If you feel that your problem is not
                                    resolved, please refer to next bullet;</li>
                                <li>Put your grievance in writing to the Veterans Inc. Grievance Officer. He or she will
                                    connect with you and gather all the written reports as well as speak to the staff
                                    involved. The Grievance Officer will respond to you within three business days.</li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="container mt-5">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-10">
                            <ul>
                                <li class="mb-3">Warnings are determined on a case by case basis, in relation to
                                    Veterans Inc.’s policy on participant termination.</li>
                                <li class="mb-3">All extenuating circumstances are taken into account, and warnings are
                                    issued only in relation to extreme situations.</li>
                                <li class="mb-3">The major issuance of a warning is in relation to a participant’s
                                    refusal of program services.</li>
                                <li class="mb-3">The authority for making determinations regarding verbal and written
                                    warnings rests with Veterans Inc. management, supported by input from the
                                    participants’ Case Manager.</li>
                                <li class="mb-3">Written notice will be provided to the participant containing a clear
                                    statement of the reasons for termination. Copies of all confirmations of verbal
                                    warnings and written warnings shall be maintained in the participant’s program file.
                                </li>
                                <li class="mb-3">Participant has the right to appeal and to have a fair review by
                                    Program Management.</li>
                                <li class="mb-3">Determinations regarding final warnings and termination from the
                                    program shall be made jointly by the Case Manager and the Program Manager. Prompt
                                    written notice of the final decision to the participant will be given.</li>
                            </ul>
                        </div>
                    </div>
                    <div class="row justify-content-center mt-5">
                        <div class="col-md-10">
                            <p>*Reasonable accommodations will be made to terminating program services in the event that
                                the head of household expires. Veterans Inc. will work with other adult occupants
                                (listed on existing lease) in securing other housing arrangements if applicable and will
                                allow said occupants to remain within the subsidy program for a determined period of
                                time.</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                ...
                <div class="form-row mt-5">
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" id="fullname" name="ev_name" class="form-control"
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="date" id="fullname" name="ev_start_date" class="form-control"
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="date" id="fullname" name="ev_date_placement" class="form-control"
                            placeholder="Enter  Date Placement Confirmed">
                    </div>
                    <div class="form-group col-md-6">
                        <label for="fullname"> Submitted By</label>
                        <input type="date" id="fullname" name="ev_submitted_by" class="form-control"
            ...
            <div class="container custom-container p-4">
                ...
                <p class="custom-paragraph mt-5">As part of its ongoing efforts to help veterans find high quality
                    careers, the Arthur M.
