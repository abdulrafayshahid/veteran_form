...
if (isset($_SESSION['veteran_username']) && isset($_SESSION['veteran_admin'])) {
  ...
  if ($result && mysqli_num_rows($result) > 0) {
    ...
    if($row['consent_blanks']){
      $consent_blanks =explode(',', $row['consent_blanks']);
    // var_dump($consent_blanks);
    ...
    <div class="container-fluid">
      <div class="container">
        ...
        <div style="width: 100%; border: 2px solid; padding: 10px; border-color: rgb(0, 0, 0);">
          ...
          <div class="rowDiv">
            ...
            <input type="text" class="lastNameInput" id="lastName"
              value="<?php echo !empty($full_legal_last_name) ? $full_legal_last_name : ''; ?>">
          ...
          <div class="row-check-container">
            ...
            <div class="form-check">
              <input class="form-check-input" type="checkbox" name="gender" id="genderNonConforming" value="NonConforming"
                <?php echo ($gender === 'Non-Conforming') ? 'checked' : ''; ?>>
          ...
          <div class="form-select-main-container">
            <div class="formCheck">
              ...
              <input type="text" class="HUD-assigned-input" id="lastName"
                value="<?php echo !empty($continuum_care_code) ? $continuum_care_code : ''; ?>">
            </div>
            <div class="formCheck">
              <label class="label">CoC Location:</label>
              <input type="text" class="Location-input" id="lastName"
                value="<?php echo !empty($coc_location) ? $coc_location : ''; ?>">
            </div>
          </div>
          <div class="row-check-container">
          ...
          <div class="form-select-main-container">
            <div class="fixed-input-container">
              ...
              <input type="text" class="fixed-input" id="lastName"
                value="<?php echo !empty($emergency_contact_name) ? $emergency_contact_name : ''; ?>">
            </div>
            <div class="fixed-input-container">
              <label for="firstName" class="label">Phone 2:</label>
              <input type="text" class="fixed-input" id="firstName"
                value="<?php echo !empty($emergency_contact_phone) ? $emergency_contact_phone : ''; ?>">
            </div>
          </div>
          <div class="form-select-main-container">
            <div class="fixed-input-container">
              ...
              <input type="text" class="fixed-input" id="lastName"
                value="<?php echo !empty($referral_source) ? $referral_source : ''; ?>">
            </div>
            <div class="fixed-input-container">
              <label for="firstName" class="label">Phone 3:</label>
              <input type="text" class="fixed-input" id="firstName"
                value="<?php echo !empty($referral_source_phone) ? $referral_source_phone : ''; ?>">
            </div>
          </div>
        </div>
        <div style="width: 100%; border: 2px solid; padding: 10px; border-color: rgb(0, 0, 0);">
          ...
          <div class="form-select-main-container">
            <div class="fixed-input-container">
              ...
              <input type="text" class="fixed-input" id="lastName"
                value="<?php echo !empty($branch_service) ? $branch_service : ''; ?>">
            </div>
            <div class="fixed-input-container">
              <label for="firstName" class="label">Service Date From to</label>
              <input type="text" class="fixed-input" id="firstName"
                value="<?php echo !empty($service_date) ? $service_date : ''; ?>">
            </div>
          </div>
          <div class="row-check-container">
          ...
          <div class="form-select-main-container">
            ...
            <div class="fixed-input-container">
              ...
              <input type="text" class="fixed-input" id="lastName"
                value="<?php echo !empty($military_mos) ? $military_mos : ''; ?>">
            </div>
          </div>
          <div class="row-check-container">
          ...
          <div class="row-check-container">
            ...
            <input type="text" class="vz-medical-center-station-input" id="lastName"
              value='<?php echo !empty($injury) ? $injury : ''; ?>'>
          </div>
        </div>
        <div style="width: 100%; border: 2px solid; padding: 10px; border-color: rgb(0, 0, 0);">
          <div class="row-check-container">
          ...
          <div class="row-check-container">
            ...
            <input type="text" class="vz-medical-center-station-input" id="lastName"
              value='<?php echo !empty($prepared_by) ? $prepared_by : ''; ?>'>
          </div>
        </div>
        ...
        <div style="width: 100%; ">
          ...
          <div class="row-check-container">
            ...
            <input type="text" class="page3-input" id="lastName"
              value="<?php echo !empty($consent_blanks[0]) ? $consent_blanks[0] : ''; ?>">



            <label for="dob" class="label">with a date of birth</label>
            <input type="text" class="page3-input" id="dob"
              value='<?php echo !empty($consent_blanks[1]) ? $consent_blanks[1] : ''; ?>'>
            <label for="ssn" class="label">and a Social Security Number of:</label>
          </div>
          <div class="row-check-container">
            <input type="text" class="page3-input" id="lastName"
              value='<?php echo !empty($consent_blanks[2]) ? $consent_blanks[2] : ''; ?>'>
          ...
          <div class="row-check-container">
            ...
            <input type="text" class="page3-input" id="lastName"
              value='<?php echo !empty($consent_blanks[3]) ? $consent_blanks[3] : ''; ?>'>
          </div>
        ...
        <div class="row-check-container">
          ...
          <input type="text" class="signature-input" id="dob"
            value='<?php echo !empty($consent_date) ? $consent_date : ''; ?>'>
        </div>
        ...
        <div style="width: 100%; padding: 20px;">
          ...
          <div class="rowDiv">
            <input type="text" class="lastNameInput" id="lastName">
            <input type="text" class="firstNameInput" id="firstName"
              value='<?php echo !empty($consent_date_2) ? $consent_date_2 : ''; ?>'>
          </div>
          <div class="rowDiv">
          ...
          <div class="rowDiv">
            <input type="text" class="lastNameInput" id="lastName">
            <input type="text" class="firstNameInput" id="firstName"
              value='<?php echo !empty($consent_date_3) ? $consent_date_3 : ''; ?>'>
          </div>
          <div class="rowDiv">
        ...
        ">
          ...
          ">
           ...
           " type="text" id="nationalArchives"
              value='<?php echo !empty($hvsv_applicant_name) ? $hvsv_applicant_name : ''; ?>'>
          </div>
        ...
        <div style="width: 100%;">
          ...
          <div class="row-check-container" style="margin-top: 20px;">
            ...
            <input type="text" class="signature-input" id="lastName"
              value='<?php echo !empty($pa_name) ? $pa_name : ''; ?>'>
          ...
          <div class="row-check-container" style="margin-top: 20px;">
            ...
            <input type="text" class="signature-input" id="lastName"
              value='<?php echo !empty($pa_case_manager_name) ? $pa_case_manager_name : ''; ?>'>
            <label for="dob" class="label">(Signature)</label>
            <input type="text" class="signature-input" id="dob">
          </div>
          <div class="row-check-container" style="margin-top: 20px;">
            ...
            <input type="text" class="signature-input" id="lastName"
              value='<?php echo !empty($pa_date) ? $pa_date : ''; ?>'>
          </div>
        </div>
        <div style="width: 100%;">
      ...
      ">
          ...
          <div class="row-check-container" style="margin-top: 20px;">
            ...
            <input type="text" class="signature-input" style="width: 30%;" id="lastName"
              value='<?php echo !empty($iep_looking_for) ? $iep_looking_for : ''; ?>'>
            <p style="font-weight: bold;">Do You Have a Resume?</p>
            <input type="text" class="signature-input" style="width: 30%;" id="lastName"
              value='<?php echo !empty($iep_resume) ? $iep_resume : ''; ?>'>
          </div>
          ...
          <input type="text" class="signature-input" style="width: 100%;" id="lastName"
            value='<?php echo !empty($iep_restrictions) ? $iep_restrictions : ''; ?>'>
          <input type="text" class="signature-input" style="width: 100%;" id="lastName">
          ...
          <input type="text" class="signature-input" style="width: 100%;" id="lastName"
            value='<?php echo !empty($iep_job_titles) ? $iep_job_titles : ''; ?>'>
          ...
          <input type="text" class="signature-input" style="width: 100%;" id="lastName"
            value='<?php echo !empty($iep_skills) ? $iep_skills : ''; ?>'>
          <input type="text" class="signature-input" style="width: 100%;" id="lastName">
          <input type="text" class="signature-input" style="width: 100%;" id="lastName">
          <input type="text" class="signature-input" style="width: 100%;" id="lastName">
          <input type="text" class="signature-input" style="width: 100%;" id="lastName">
          ...
          <input type="text" class="signature-input" style="width: 100%;" id="lastName"
            value='<?php echo !empty($iep_short_term_goal) ? $iep_short_term_goal : ''; ?>'>
          <input type="text" class="signature-input" style="width: 100%;" id="lastName">
          <p style="font-weight: 500; margin-top: 20px;"><b> Long Term Goal:</p>
          <input type="text" class="signature-input" style="width: 100%;" id="lastName"
            value='<?php echo !empty($iep_long_term_goal) ? $iep_long_term_goal : ''; ?>'>
          <input type="text" class="signature-input" style="width: 100%;" id="lastName">
          <p style="font-weight: 500; margin-top: 20px;"><b> Any Training Required</p>
          <input type="text" class="signature-input" style="width: 100%;" id="lastName"
            value='<?php echo !empty($iep_training) ? $iep_training : ''; ?>'>
          <input type="text" class="signature-input" style="width: 100%;" id="lastName">
        </div>
        ...
        <div style="width: 100%;">
          ...
          <div class="row-check-container" style="margin-top: 20px;">
            ...
            <input type="text" class="signature-input" style="width: 80%;" id="lastName"
              value='<?php echo !empty($ev_address) ? $ev_address : ''; ?>'>
          </div>
          <div class="row-check-container" style="margin-top: 20px;">
            <p style="font-weight: 500;">Phone Number</p>
            <input type="text" class="signature-input" style="width: 30%;" id="lastName"
              value='<?php echo !empty($ev_phone_number) ? $ev_phone_number : ''; ?>'>
          </div>
          ...
          <div class="row-check-container" style="margin-top: 20px;">
            ...
            <input type="text" class="signature-input" style="width: 35%;" id="lastName"
              value='<?php echo !empty($ev_employer_name) ? $ev_employer_name : ''; ?>'>
            <p style="font-weight: 500;">Start Date</p>
            <input type="text" class="signature-input" style="width: 35%;" id="lastName"
              value='<?php echo !empty($ev_start_date) ? $ev_start_date : ''; ?>'>
          </div>
          ...
          <div class="row-check-container" style="margin-top: 20px;">
            <p style="font-weight: 500;">Phone Number</p>
            <input type="text" class="signature-input" style="width: 30%;" id="lastName"
              value='<?php echo !empty($ev_phone_number_2) ? $ev_phone_number_2 : ''; ?>'>
          </div>
          <div class="row-check-container" style="margin-top: 20px;">
            <p style="font-weight: 500;">Contact Person</p>
            <input type="text" class="signature-input" style="width: 35%;" id="lastName"
              value='<?php echo !empty($ev_contact_person) ? $ev_contact_person : ''; ?>'>
            <p style="font-weight: 500;">Title</p>
            <input type="text" class="signature-input" style="width: 45%;" id="lastName"
              value='<?php echo !empty($ev_title) ? $ev_title : ''; ?>'>
          </div>
          <div class="row-check-container" style="margin-top: 20px;">
            <p style="font-weight: 500;">Client's Job Title</p>
            <input type="text" class="signature-input" style="width: 30%;" id="lastName"
              value='<?php echo !empty($ev_clients_job_title) ? $ev_clients_job_title : ''; ?>'>
            <p style="font-weight: 500;">HRS per week</p>
            <input type="text" class="signature-input" style="width: 18%;" id="lastName"
              value='<?php echo !empty($ev_hrs_week) ? $ev_hrs_week : ''; ?>'>
            <p style="font-weight: 500;">Wage</p>
            <input type="text" class="signature-input" style="width: 22%;" id="lastName"
              value='<?php echo !empty($ev_wage) ? $ev_wage : ''; ?>'>
          </div>
          <div class="row-check-container" style="margin-top: 20px;">
            <p style="font-weight: 500; ">Veterans Inc. Provided: Tools, Uniform, Supplies</p>
            <input type="text" class="signature-input" style="width: 60%;" id="lastName"
              value='<?php echo !empty($ev_veterans_provided) ? $ev_veterans_provided : ''; ?>'>
          </div>
          <div class="row-check-container" style="margin-top: 20px;">
            <p style="font-weight: 500;">Date Placement Confirmed</p>
            <input type="text" class="signature-input" style="width: 35%;" id="lastName"
              value='<?php echo !empty($ev_date_placement) ? $ev_date_placement : ''; ?>'>
          ...
          <div class="row-check-container" style="margin-top: 20px;">
            ...
            <input type="text" class="signature-input" style="width: 80%;" id="lastName"
              value='<?php echo !empty($ev_submitted_by) ? $ev_submitted_by : ''; ?>'>
        ...
        <div style="margin-left: 50px; margin-right: 50px; padding: 10px; ">
          <h5 class="card-subtitle mb-4 text-center" style="text-decoration: underline;"><b> CALL OF DUTY
              ENDOWMENT<br>VETERAN PROFILES RELEASE</b></h5>
          <p style="text-align: justify; margin-top: 100px; font-weight: 500;">As part of its ongoing efforts to help
            veterans find high
          ...
          <input type="text" class="signature-input" id="lastName"
            value='<?php echo !empty($cod_printed_name) ? $cod_printed_name : ''; ?>'>
          <h6><b>Printed Name :</b></h6>
          <div style="width: 100%; padding: 10px; margin-top: 20px;"></div>
          <input type="text" class="signature-input" id="lastName"
            value='<?php echo !empty($cod_date) ? $cod_date : ''; ?>'>
          <h6><b>Date :</b></h6>
        </div>
        <div style="width: 100%; padding: 10px; margin-top: 1000px;"></div>
        <div style="width: 100%; padding: 10px; margin-top: 100px;"></div>
        <div style="margin-left: 50px; margin-right: 50px; padding: 10px; ">
          <h5 class="card-subtitle mb-4 text-center" style="text-decoration: underline;"><b> Arthur M. Blank Family
              Foundation<br>VETERAN PROFILES RELEASE</b></h5>
          <p style="text-align: justify; margin-top: 100px; font-weight: 500;">As part of its ongoing efforts to help
            veterans find high quality careers, the Arthur M.
            ...
            success story. <br><br>Congratulations on your success. Please sign below confirming your consent. Thank you.
          </p>
          <div style="width: 100%; padding: 10px; margin-top: 100px;"></div>
          <input type="text" class="signature-input" id="lastName">
          <h6><b>Signature :</b></h6>
        ...
        <div style="width: 100%; padding: 10px; margin-top: 100px;"></div>
        <div style="margin-left: 50px; margin-right: 50px; padding: 10px; ">
          <p style="text-align: justify; margin-top: 100px; font-weight: 500; font-size: 30px; color: #335179;">Arthur M.
            Blank Foundation:</p>
          <p style="text-align: justify; margin-top: 100px; font-weight: 500; font-size: 30px; color: #335179;">I would
            like to send my sincerest gratitude to all of you
